...
window.onload = function () {
    ...
    var tableTemplateNode = document.getElementById('table-template'),
        tableStructure = tableTemplateNode.innerHTML,
        tableTemplate = Handlebars.compile(tableStructure),
        container = document.getElementById('container');

    container.innerHTML = tableTemplate({ lectures: lectures });
};